...
public class InternalExtractionController {
	...
	public void receiveExtraction(@PathVariable UUID documentId, @RequestBody ExtractionCallbackRequest request)
			throws Exception {
	...
	public record ExtractionCallbackRequest(
			@NotBlank String documentType, @NotNull Double confidence, @NotNull Map<String, Object> extractedFields) {}
}
